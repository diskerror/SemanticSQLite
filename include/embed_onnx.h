...
#ifndef SEMEXT_EMBED_ONNX_H
#define SEMEXT_EMBED_ONNX_H
...
int semext_onnx_encode(const char *text, int text_len,
                       float **out, int *out_dims);

// Free any cached model/session. Call at process exit.
void semext_onnx_shutdown(void);

#ifdef __cplusplus
}
#endif

#endif /* SEMEXT_EMBED_ONNX_H */
